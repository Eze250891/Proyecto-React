...
const Seccion4 = () => {
  return (
    <div className='w-screen flex bg-secondary items-center p-8 gap-3 flex-col  md:flex-row md:justify-center'>
    
            <div className='p-2 mt-5 flex-auto w-64'>
                <h3 className='text-fontPrimary sm:text-lg sm:ml-5 sm:mt-9 md:text-lg lg:text-lg 2xl:text-lg font-bold'>Titulo 1</h3>
            ...
            <div className=' p-5 mt-5 flex-auto w-72 '>
                ...
                <h3 className='text-fontPrimary sm:text-lg sm:ml-5 sm:mt-9 md:text-lg lg:text-lg 2xl:text-lg font-bold'>Titulo 2</h3>
                <div className=''> Lorem 2 ipsum dolor sit amet consectetur adipisicing elit. Facere doloremque harum pariatur
                 sunt quisquam, sequi esse excepturi eius maiores nesciunt corrupti voluptas! Tempora
                  obcaecati tenetur soluta dolorum neque, optio voluptas.</div>
            </div>
            <div className='p-2 mt-5 flex-auto w-64 '>
                <h3 className='text-fontPrimary sm:text-lg sm:ml-5 sm:mt-9 md:text-lg lg:text-lg 2xl:text-lg font-bold'>Titulo 3</h3>
